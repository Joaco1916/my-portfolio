...
const TopBanner = ({ language, handleLanguageChange }) => {
  ...
  return (
    <Grid item xs={12}>
      <Box
        sx={{
          background: `linear-gradient(90deg, ${colorPalette.stormi.darkest} 20%, ${colorPalette.stormi.darker} 40%, ${colorPalette.stormi.normal} 60%, ${colorPalette.stormi.light} 80%, ${colorPalette.stormi.lightest} 90%)`,
          width: '100%',
          height: '100%',
          display: 'flex',
          padding: 4,
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              ...
              >
                <BlindableSwitch
                  checked={!blindable}
                  onChange={() => setBlindable(!blindable)}
                />
                <Image
